    ...
    .then(function () {
      return Promise.all([
        ...
        knex('rooms').insert({
          ...
          amenity_1: 'In-unit Laundry',
          amenity_2: 'Cats Allowed',
          amenity_3: 'Dogs Allowed',
          amenity_4: 'Off-street Parking',
          rent_cost: 600,
          lease_length: 6,
          bedrooms: 3,
          bathrooms: 2,
          room_description: 'Two bedrooms available in this Baker home. One has its own master bathroom and fireplace. High ceilings, updated kitchen with granite and stainless appliances, hard wood floors. Very charming.',
          cross_street_1: 'Bannock St',
          cross_street_2: 'W Second Ave',
          city: 'Denver',
          state: 'CO',
          zip_code: 80223,
          image_1: 'http://photos.zillowstatic.com/p_f/ISq1aaol2gwmhq0000000000.jpg',
          image_2: 'http://photos.zillowstatic.com/p_f/IS6uux3c9va6iq0000000000.jpg',
          image_3: 'http://photos.zillowstatic.com/p_f/IS6eeyoyawchhq0000000000.jpg',
          image_4: 'http://photos.zillowstatic.com/p_f/ISm6zl4phbr0iq0000000000.jpg',
          neighborhood: 'Baker',
          user_id: knex('users').select('id').where('first_name', 'James')
        }),
        knex('rooms').insert({
          housing_type: 'Single-family Home',
          amenity_1: 'Fenced Backyard',
          amenity_2: 'Storage',
          amenity_3: 'Dogs Allowed',
          amenity_4: 'In-unit Laundry',
          rent_cost: 700,
          lease_length: 12,
          bedrooms: 2,
          bathrooms: 1,
          room_description: 'Charming bungalow in the popular Highlands Neighborhood. Enjoy the bright, open kitchen layout. Relax in the front sun room. Get your hands dirty in the garden. Your bedroom is on the lower level which has a large living room plus its own full bathroom. You would also have your own private entry. Live on a nice, quiet block that has a ton of character and charm!',
          cross_street_1: 'Osage St.',
          cross_street_2: 'W 40th Ave',
          city: 'Denver',
          state: 'CO',
          zip_code: 80211,
          image_1: 'http://photos.zillowstatic.com/p_f/ISa9dhoayc3vq51000000000.jpg',
          neighborhood: 'Sunnyside',
          user_id: knex('users').select('id').where('first_name', 'Ashley')
        }),
        knex('rooms').insert({
          housing_type: 'Apartment',
          amenity_1: 'Fitness Center',
          amenity_2: 'Pool',
          amenity_3: 'Cats Allowed',
          amenity_4: 'Central Air',
          rent_cost: 950,
          lease_length: 8,
          bedrooms: 2,
          bathrooms: 1,
          room_description: 'My roommate had to move away for work, so I have a bedroom available in my apartment. It\'s a large apartment community that is centrally located in the Ballpark neighborhood of downtown Denver, between the Central Business District and RiNo. Only half of a mile to the Union Station RTD Light Rail and easy access to I-70 and I-25. The unit is very clean and has a small patio. Your room is off the living room and faces north. Come check it out!',
        ...
        knex('rooms').insert({
          ...
          bedrooms: 2,
          bathrooms: 1,
          room_description: 'Classic Victorian row home has been completely renovated and lives very large. Great location! Walking distance to restaurants and shops. Five blocks from Washington Park. Over 1000 finished sqft on 2 levels. Great open living space with hardwood floors, working fireplace, updated granite kitchen and bath.',
